...
function BuyContent() {
  ...
  useEffect(() => {
    async function fetchProperties() {
      ...
      // Filter for-sale properties only (including 'both')
      const forSaleProperties = data.filter(p => p.status === 'for-sale' || p.status === 'both');
        ...
        <Container>
          ...
          >
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-cream-light mb-6">
              Properties <span className="text-cream-light">For Sale</span>
            </h1>
      ...
      <Container>
        ...
        >
          ...
          <p className="text-base md:text-lg lg:text-xl text-cream-light max-w-3xl mx-auto">
            Discover luxury properties for sale across Egypt and London's most prestigious locations.
          </p>
        </motion.div>
